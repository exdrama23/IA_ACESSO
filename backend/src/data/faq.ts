  ...
  internet_fibra: [
    {
      ...
      questions: [
        ...
        "Qual o valor dos serviços de internet da empresa?",
        "Quanto custa a internet da Acesso?",
        "Qual o preço da internet Acesso?",
        "Valores dos planos de internet da empresa",
        "Tabela de preços da internet Acesso",
        "Quanto custa para colocar internet?",
        "Qual o valor da mensalidade da internet?",
        "Quais pacotes de internet vocês oferecem?",
        "Quero saber o valor da instalação e mensalidade da fibra",
      ...
      keywords: ["fibra", "internet", "velocidade", "mega", "preço", "mensalidade", "acesso", "valor", "serviço"],
